...
class TestSectionDB(TestCase):
    ...
    def test_get_list(self):
        ...
        kps = ['□P-50x50x1.6', '□P-50x50x2.3', '□P-50x50x3.2', '□P-60x60x1.6', '□P-60x60x2.3', '□P-60x60x3.2',
              ...
              '□P-125x125x9.0','□P-150x150x4.5', '□P-150x150x6.0', '□P-150x150x9.0', '□P-175x175x4.5', '□P-175x175x6.0',
              '□P-175x175x9.0',
              '□P-200x200x4.5', '□P-200x200x6.0', '□P-200x200x8.0', '□P-200x200x9.0', '□P-60x30x1.6', '□P-60x30x2.3',
              '□P-60x30x3.2',
              '□P-75x45x1.6', '□P-75x45x2.3', '□P-75x45x3.2', '□P-100x50x1.6', '□P-100x50x2.3', '□P-100x50x3.2',
              '□P-100x50x4.5', '□P-125x75x2.3', '□P-125x75x3.2', '□P-125x75x4.5', '□P-125x75x6.0', '□P-150x75x3.2',
              '□P-150x75x4.5', '□P-150x100x3.2', '□P-150x100x4.5', '□P-150x100x6.0', '□P-200x100x4.5', '□P-200x100x6.0',
              '□P-200x150x4.5', '□P-200x150x6.0', '□P-200x150x9.0', '□P-250x150x4.5', '□P-250x150x6.0',
              '□P-250x150x9.0']
        ps = ['P-27.2x1.9', 'P-27.2x2.3', 'P-42.7x2.3', 'P-48.6x2.3', 'P-48.6x3.2', 'P-60.5x2.3', 'P-60.5x2.8',
             ...
             'P-101.6x3.5',
             'P-101.6x4.2', 'P-114.3x2.8', 'P-114.3x3.5', 'P-114.3x4.5', 'P-114.3x6', 'P-139.8x3.5', 'P-139.8x4',
             'P-139.8x4.5', 'P-139.8x5', 'P-165.2x3.8', 'P-165.2x4', 'P-165.2x4.5', 'P-165.2x5', 'P-190.7x5.3']
